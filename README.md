...
**The strategic direction and planned features for this project are further detailed in the planning branch of the repository: [Insight for Good Platform Planning Branch](https://github.com/eeshvardasikcm/insight-for-good-platform-adk/tree/planning). This branch provides context for the development efforts undertaken for this hackathon submission.**
