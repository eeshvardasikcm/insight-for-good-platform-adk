...
2.  **Information Required:** The expression of interest preferrably could include [Specify details, e.g., name, affiliation (if any), reason for interest, acknowledgement of council fees/costs].
